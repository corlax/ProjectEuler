...
For example, M(3,6)=123 and M(4,6)=23.And, &Sigma;M(C,6)=146 for 3 &le; C &le; 4.





You are given that &Sigma;M(C,10)=10382 for 3 &le; C &le; 10.



Find &Sigma;M(C,30) for 3 &le; C &le; 40.
'''