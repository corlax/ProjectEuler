...
(i.e. 0 &le; yi &lt; 232, every value equally likely).
...
It can be seen that eventually there will be an index N such that xi = 232 -1 (a bit-pattern of all ones) for all i &ge; N.
