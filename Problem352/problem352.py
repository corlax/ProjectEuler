...
Thus, the expected number of tests for each group is 1 + 0.0960792032 &times; 5 = 1.480396016.

Consequently, all 5 groups can be screened using an average of only 1.480396016 &times; 5 = 7.40198008 tests, which represents a huge saving of more than 70% !
...
Find &Sigma;T(10000, p) for p=0.01, 0.02, 0.03, ... 0.50.
