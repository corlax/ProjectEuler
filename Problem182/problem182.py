...
To decrypt the text, the following procedure is needed: calculate d such that ed=1 mod &phi;, then for each encrypted message, c, calculate m=cd mod n.
...
If we choose e=181, then, although gcd(181,648)=1 it turns out that all possible messages
 ...
 m (0&le;m&le;n-1) are unconcealed when calculating me mod n.
