...
For example, if the clock is fed the number 137, it will show: "137" &rarr; "11" &rarr; "2" and then it will go black, waiting for the next number.
...
(2 + 5 + 4) &times; 2 = 22 transitions ("137" on/off).
...
(2 + 2) &times; 2 = 8 transitions ("11" on/off).
...
(5) &times; 2 = 10 transitions ("2" on/off).
...
The two clocks are fed all the prime numbers between A = 107 and B = 2&times;107. 
