...
C(500, &radic;2, &radic;3) = 13.22073197...

C(20000, 5, 7) = 82

C(2000000, &radic;5, &radic;7) = 49.63755955...



Let Fk be the Fibonacci numbers: Fk = Fk-1 + Fk-2 with base cases F1 = F2 = 1.Find &sum;1&le;k&le;30&nbsp;C(1012, &radic;k, &radic;Fk), and give your answer rounded to 8 decimal places behind the decimal point.
'''