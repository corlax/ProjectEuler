...
For example, if f&thinsp;=&thinsp;1/4,  for the first toss you bet &pound;0.25, and if heads comes up you win &pound;0.5 and so then have &pound;1.5. You then bet &pound;0.375 and if the second toss is tails, you have &pound;1.125.
