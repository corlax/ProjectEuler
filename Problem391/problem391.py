'''
Let sk be the number of 1&rsquo;s when writing the numbers from 0 to k in binary.

For example, writing 0 to 5 in binary, we have 0, 1, 10, 11, 100, 101. There are seven 1&rsquo;s, so s5 = 7.

The sequence S = {sk : k &ge; 0} starts {0, 1, 2, 4, 5, 7, 9, 12, ...}.
...
Given &Sigma;(M(n))3 = 8150 for 1 &le; n &le; 20.
...
Find &Sigma;(M(n))3 for 1 &le; n &le; 1000.
'''